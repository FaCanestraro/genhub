                ...
                <form @submit.prevent="handleLogin" class="space-y-4">
                    <div>
                        ...
                        <input
                            ...
                            type="email"
                            required
                            class="w-full bg-gray-800 border border-gray-700 rounded-lg px-4 py-2.5 text-white placeholder-gray-500 focus:outline-none focus:border-lime-500 transition-colors"
                    ...
                    <button
                        type="submit"
                        :disabled="loading"
                        class="w-full bg-lime-600 hover:bg-lime-700 disabled:opacity-50 text-white font-medium py-2.5 rounded-lg transition-colors"
                    >
