                ...
                <div class="flex items-start gap-4">
                    ...
                    <div>
                        <div class="flex items-center gap-3">
                            <div class="w-9 h-9 rounded-full bg-lime-600/20 flex items-center justify-center text-lime-400 font-bold text-sm flex-shrink-0">
            ...
            <div class="flex flex-1 overflow-hidden">
                ...
                <div class="flex-1 overflow-y-auto flex flex-col border-r border-gray-800">
                    <div class="flex items-center justify-between px-6 py-4 border-b border-gray-800">
                        ...
                        <button v-if="auth.can('leads', 'create')" @click="openAddActivity" class="flex items-center gap-1.5 text-sm text-lime-400 hover:text-lime-300 border border-lime-800 hover:border-lime-600 px-3 py-1.5 rounded-lg transition-colors">
                ...
                <div class="w-80 flex-shrink-0 flex flex-col overflow-hidden">
                    ...
                    <div v-if="activeTab === 'tarefas'" class="flex-1 overflow-y-auto p-4">
                        <button v-if="auth.can('tasks', 'create')" @click="openAddTask" class="w-full flex items-center gap-2 text-sm text-lime-400 hover:text-lime-300 border border-lime-800 hover:border-lime-600 rounded-lg px-3 py-2 transition-colors mb-3">
...
const statuses = [
    ...
    { value: 'negociacao',    label: 'Negociação',    selectClass: 'text-lime-300' },
...
function statusClass(v) {
    const map = {
        ...
        negociacao: 'text-lime-300', fechado: 'text-green-300',
    }
    return map[v] ?? ''
}
...
function activityIconClass(type) {
    return {
        ...
        tarefa:        'bg-lime-500/20 text-lime-400',
